          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {publications.map((pub, idx) => (
              <motion.div key={idx} variants={itemVariants} className="minimal-card">
                ...
                <h2 className="section-title" style={{ color: '#fff', marginBottom: '1rem', letterSpacing: '2px' }}>
                  {pub.title}
                </h2>

                <p className="body-text" style={{ fontSize: '1.2rem', marginBottom: '1.5rem', fontStyle: 'italic', color: '#fff' }}>
                  in {pub.featured}
                </p>
